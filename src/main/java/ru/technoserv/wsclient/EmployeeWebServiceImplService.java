    ...
    extends Service
{
    ...
    public ru.technoserv.ws.EmployeeWebService getEmployeeWebServiceImpl() {
        return super.getPort(new QName("http://ws.technoserv.ru/", "EmployeeWebServiceImpl"), ru.technoserv.ws.EmployeeWebService.class);
    }
     ...
     */
    @WebEndpoint(name = "EmployeeWebServiceImpl")
    public ru.technoserv.ws.EmployeeWebService getEmployeeWebServiceImpl(WebServiceFeature... features) {
